...
var Key = /*#__PURE__*/function (_React$Component) {
  ...
  function Key() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onPlayNoteInput", function () {
      ...
      console.log('PLAYNOTEINPUT PROPS', _this.props);
    });
...
var ControlledPiano = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper(ControlledPiano);
...
var Piano = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Piano, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.highlightedNotes !== this.props.highlightedNotes && this.state.highlightedNotes !== this.props.highlightedNotes) {
        this.setState({
          highlightedNotes: this.props.highlightedNotes || []
        });
      }
